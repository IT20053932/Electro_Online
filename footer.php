    ...
    <div class="row no-gutters_footer justify-content-between">
      <div class="col-lg-3 col-sm-6">
        <div class="single-box d-flex flex-column gap-3">
          <img src="images/weblogo.png" alt="" class="logo-footer" />
          <p class="brand-bio">
            Electro Online is a premier online destination for all your
            ...
            technology-filled journey at Electro Online.
          </p>
...
<section class="head">
  <div class="container d-flex justify-content-center py-1 head_container">
    <div class="head-row d-flex gap-4">
      <div class="phone">
        <p>Developed by Buddhima_Arampath</p>
      </div>
      <div class="mail">
